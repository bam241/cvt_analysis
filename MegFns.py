...
def mplot(x, y,
          xtit = '', ytit = '', tit = '', xs = 15, ys = 5,
          thick = 1, font_wt = 1, fs = 14, color = 0):
...
#    plt.set_size_inches(xs,ys)
    plt.xlabel(xtit, weight = text_weight(font_wt))
    plt.ylabel(ytit, weight = text_weight(font_wt))
    plt.title(tit, weight = text_weight(font_wt))
